...
A sample script to setup the app authentication is available in this repo: [Setup-PnPPowerShellAppAuthentication.ps1](https://github.com/wortell/DataMigrationFactory/blob/main/Authentication/Setup-PnPPowerShellAppAuthentication.ps1).
